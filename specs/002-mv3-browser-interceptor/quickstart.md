...
- UHDD daemon running at `http://localhost:8000`
...
3. **Trigger a download**:
   ...
   - Expected: Chrome notification "UHDD: Download Queued" appears
...
5. **Verify offline fallback**:
   - Stop the UHDD daemon
   - Click a download link
   - Expected: Chrome's native download proceeds normally
   - Expected: Chrome notification "UHDD: Backend Offline" appears
...
- **Anti-loop guard too aggressive**: Check the console for `[UHDD SW] Skipping localhost download`
