...
#### [MODIFY] [manifest.json](file:///home/abdallah/Desktop/dark-downloader/extension/manifest.json)
...
#### [MODIFY] [background.js](file:///home/abdallah/Desktop/dark-downloader/extension/background.js)
...
#### [REWRITE] [content.js](file:///home/abdallah/Desktop/dark-downloader/extension/content.js)
...
- **Shadow DOM Setup**: Create `div#uhdd-host`, attach a closed shadow root, and inject `<link rel="stylesheet" href="${chrome.runtime.getURL('content.css')}">`.
...
#### [REWRITE] [content.css](file:///home/abdallah/Desktop/dark-downloader/extension/content.css)
